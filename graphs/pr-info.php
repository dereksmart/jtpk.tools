...
$total_issues = $wpdb->get_results( 'SELECT * FROM gh_stats WHERE meta_key = "total_prs" order by date ASC', OBJECT );
...
$total_issues = $wpdb->get_results( 'SELECT * FROM gh_stats WHERE meta_key = "prs_need_review" order by date ASC', OBJECT );
...
$graph->title->Set('Open PRs (total and waiting for review)');
